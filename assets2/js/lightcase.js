	...
	var _self = {
		...
		start: function (options) {
			...
			_self.settings = lightcase.settings = $.extend(true, {
				...
				markup: function () {
					$('body').append(
						_self.objects.overlay = $('<div id="' + _self.settings.idPrefix + 'overlay" class="turnScrollOn"></div>'),
					...
					_self.objects.nav.append(
						_self.objects.close = $('<a href="#" class="' + _self.settings.classPrefix + 'icon-close turnScrollOn"><span>' + _self.settings.labels['close'] + '</span></a>'),
